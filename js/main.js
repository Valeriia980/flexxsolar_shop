      ...
      $("form").each(function() {
         $(this).on("submit", function() {
            $(this).validate({
               ...
               messages: {
                  name: "Schrijf de juiste naam",
                  tel: "Dit is een verplicht veld",
                  email: "Schrijf de juiste e-mail",
                  password: "Schrijf het juiste wachtwoord",
                  comment: "Vul het veld in"
               },
   ...
   var productPrevSlider = function() {
      ...
      productSlider.on("init afterChange", function(
         ...
         if (slick.slideCount > 4) {
            ...
            sliderCount.text("Pagina " + i + " van " + slick.slideCount);
         }
      });
      productSlider.slick({
         slidesToShow: 4,
